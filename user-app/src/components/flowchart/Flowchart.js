...
import { addComponent, updateComponents, setPosition, updatePosition, setConnectedComponents, } from '../../redux/actions/flowChartAction';
...
const Flowchart = (props) => {
    ...
    const { problem } = props;
    const { components, position, moveComponent } = props.flowChart;
